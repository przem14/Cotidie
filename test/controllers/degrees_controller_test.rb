...
class DegreesControllerTest < ActionController::TestCase
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post :create, degree: { activity: @degree.activity, description: @degree.description, value: @degree.value }
    end
  ...
  test "should update degree" do
    patch :update, id: @degree, degree: { activity: @degree.activity, description: @degree.description, value: @degree.value }
    assert_redirected_to degree_path(assigns(:degree))
  end
